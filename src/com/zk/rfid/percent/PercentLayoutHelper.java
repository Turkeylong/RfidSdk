 ...
 * single line implementation {@code PercentLayoutHelper.fetchWidthAndHeight(this, a,
...
public class PercentLayoutHelper
{
	...
	private void invokeMethod(String methodName, int widthHint, int heightHint, View view, Class clazz,
			PercentLayoutInfo.PercentVal percentVal) throws NoSuchMethodException, IllegalAccessException,
	 ...
	 * space than it deliveryOrderd through the percentage dimension.
	 * <p/>
	 ...
	 * deliveryOrders too little space, it will be remeasured with width set to
	 * {@code WRAP_CONTENT}.
	 * 
	 * @return True if the measure phase needs to be rerun because one of the
	 *         children would like to deliveryOrder more space.
	 */
	...
	public static class PercentLayoutInfo
	{
		...
		public void fillLayoutParams(ViewGroup.LayoutParams params, int widthHint, int heightHint)
		{
			...
			/*
			 * if (widthPercent >= 0) { params.width = (int) (widthHint *
			 * widthPercent); } if (heightPercent >= 0) { params.height = (int)
